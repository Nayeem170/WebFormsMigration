...
This project has been migrated to ASP.NET Core using `CoreWebForms.Sdk`. See the migrated project at `../CoreWebForms/` and the step-by-step migration guide in `../CoreWebForms/docs/migration/`.
